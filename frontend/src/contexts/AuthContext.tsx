...
export function AuthProvider({ children }: IAuthProvider) {
    ...
    const [user, setUser] = useState(()=> {
      const user = localStorage.getItem('user:semana-hero');
      if(user) {
    ...
    async function signIn({ email, password }: ISignIn) {
      try {
        ...
        localStorage.setItem('refresh_token:semana-hero', refresh_token);
        localStorage.setItem('user:semana-hero', JSON.stringify(userData));
